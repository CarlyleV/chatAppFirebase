    ...
    <div>
        ...
        <footer>
            <form @submit.prevent="sendMessage" class="sendMessageForm">
                ...
                <button type="submit" value="Send" :class="sendMessageText?'writeMessageButton able':'writeMessageButton disable'">
...
export default {
    ...
    methods: {
        ...
        scrollH(){
          ...
          if(this.dateList.length===1){
              ...
              this.dateList[0].style.left=" calc(50% - 90px/2)";
              console.log('moving + 0')
          }else if(this.$refs.box.scrollTop < (this.absoluteDateList[this.absoluteDateList.length-1].offsetTop-this.$refs.box.offsetTop)){
             for(let i=0; i < this.dateList.length-1; i++){
                 if(this.$refs.box.scrollTop+this.$refs.box.offsetTop>this.absoluteDateList[i].offsetTop && 
                    this.$refs.box.scrollTop < (this.absoluteDateList[i+1].offsetTop-this.$refs.box.offsetTop-40)){
                        this.dateList[i].style.position="fixed";
                        this.dateList[i].style.top=this.$refs.box.offsetTop+10+"px"
                        this.dateList[i].style.left="calc(50% - 90px/2)";
              ...
              this.dateList[this.dateList.length-1].style.left=" calc(50% - 90px/2)";
    ...
    mounted(){
        ...
        this.$refs.box.onscroll = this.scrollH;
        
      
        this.$nextTick(()=>console.log(this.dateList[1].offsetTop));
        this.$nextTick(()=>console.log(this.absoluteDateList[1].offsetTop))
        
        //  this.$nextTick(()=>console.log(this.$refs.box.offsetTop))
...
.writeMessage .writeMessageButton{
